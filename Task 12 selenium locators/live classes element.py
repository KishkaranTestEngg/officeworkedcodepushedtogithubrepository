...
# =========================
# Find "LIVE Classes" field
# =========================

live_classes = driver.find_element(By.XPATH, "//p[text()='LIVE Classes']")

# Mouse hover action
actions = ActionChains(driver)
actions.move_to_element(live_classes).perform()
...
parent = live_classes.find_element(By.XPATH, "..")
...
following = live_classes.find_elements(By.XPATH, "following-sibling::*")
...
preceding = live_classes.find_elements(By.XPATH, "preceding-sibling::*")
...
ancestors = live_classes.find_elements(By.XPATH, "ancestor::*")
...
following_nodes = live_classes.find_elements(By.XPATH, "following::*")
...
preceding_nodes = live_classes.find_elements(By.XPATH, "preceding::*")
...
self_node = live_classes.find_element(By.XPATH, "self::*")
