...
preceding = courses.find_elements(By.XPATH, "preceding-sibling::*")
...
following_nodes = courses.find_elements(By.XPATH, "following::*")
...
preceding_nodes = courses.find_elements(By.XPATH, "preceding::*")
...
self_node = courses.find_element(By.XPATH, "self::*")
