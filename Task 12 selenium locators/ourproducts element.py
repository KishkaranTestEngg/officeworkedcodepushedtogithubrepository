...
# =========================
# Find "Our Products" field
# =========================

our_products = driver.find_element(By.XPATH, "//p[text()='Our Products']")

# Mouse hover action
actions = ActionChains(driver)
actions.move_to_element(our_products).perform()
...
parent = our_products.find_element(By.XPATH, "..")
...
following = our_products.find_elements(By.XPATH, "following-sibling::*")
...
preceding = our_products.find_elements(By.XPATH, "preceding-sibling::*")
...
ancestors = our_products.find_elements(By.XPATH, "ancestor::*")
...
following_nodes = our_products.find_elements(By.XPATH, "following::*")
...
preceding_nodes = our_products.find_elements(By.XPATH, "preceding::*")
...
self_node = our_products.find_element(By.XPATH, "self::*")
