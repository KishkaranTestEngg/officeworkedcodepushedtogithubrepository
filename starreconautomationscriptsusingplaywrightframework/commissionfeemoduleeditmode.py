...
def run(playwright: Playwright) -> None:
    ...
    page.get_by_role("textbox", name="Financial * Network Name *").fill("52")
    page.get_by_role("textbox", name="Financial * Network Name *").press("ArrowRight")
    page.get_by_role("textbox", name="Financial * Network Name *").press("ArrowRight")
    page.get_by_role("textbox", name="Financial * Network Name *").press("ArrowRight")
    page.get_by_role("textbox", name="Enter a To Amount").click()
    page.get_by_role("textbox", name="Enter a To Amount").fill("20222")
    page.get_by_label("Edit Commission Fee").get_by_role("button", name="Edit").click()
